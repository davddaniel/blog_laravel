                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <div class="custombox clearfix">
                                <h4 class="small-title">Editar Post</h4>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form class="form-wrapper" method="POST" action="{{ route('edit', ['id'=>$post->id]) }}">
                                            @method('PUT')
                                            <input type="text" name="titulo" class="form-control" placeholder="Titulo" value="{{ $post->titulo }}">
                                            <input type="text" name="autor" class="form-control" placeholder="Autor" value="{{ $post->autor }}">
                                            <input type="text" name="slug" class="form-control" placeholder="slug" value="{{ $post->slug }}">
                                            <textarea class="form-control" name="conteudo" rows="20" placeholder="Sua publicação">{{ $post->conteudo }}</textarea>
